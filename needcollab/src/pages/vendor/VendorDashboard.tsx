...
export default function VendorDashboard() {
  ...
  const stats = [
    { label: 'Mes offres', value: myOffers.length, icon: Package, color: 'text-primary' },
    { label: 'Collaborations', value: activeCollabs.length, icon: MessageSquare, color: 'text-accent' },
    { label: 'Besoins ouverts', value: openNeeds.length, icon: FileText, color: 'text-warning' },
    { label: 'Taux acceptation', value: '50%', icon: TrendingUp, color: 'text-success' },
  ];

  return (
    <div className="container py-8">
      <h1 className="mb-6 text-3xl font-bold">Dashboard Vendor</h1>
      ...
      <h2 className="mb-4 text-xl font-semibold">Derniers besoins ouverts</h2>
          ...
          <Card key={need.id}>
            <CardContent className="flex items-center justify-between p-4">
              ...
              <div className="text-right">
                ...
                <Badge variant="outline" className="text-xs">{need.offersCount} offres</Badge>
              </div>
            </CardContent>
          </Card>
        ))}
