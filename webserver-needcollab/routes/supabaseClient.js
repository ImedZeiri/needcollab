...
// Edge functions that require admin privileges
const ADMIN_FUNCTIONS = ['send-auth-email'];
...
async function callEdgeFunction(functionName, method, body = null, queryParams = {}) {
  ...
  const authKey = ADMIN_FUNCTIONS.includes(functionName) && SUPABASE_SERVICE_ROLE_KEY
